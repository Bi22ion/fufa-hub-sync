...
export const Route = createFileRoute("/schedule")({
  head: () => ({
    meta: [
      { title: "Schedule — FUFA TV" },
      { name: "description", content: "Full football programming schedule on FUFA TV." },
    ],
  }),
    ...
    <Layout>
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <ul className="mt-6 space-y-3">
          {items.length === 0 && (
            <li className="rounded-xl border border-border bg-surface p-6 text-center text-muted-foreground">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="rounded bg-primary/30 px-2 py-0.5 text-xs font-bold uppercase text-accent">
                      {p.type}
                    </span>
                    {comp && (
                    ...
                    {isLive && (
                      <span className="flex items-center gap-1 rounded bg-accent-red px-2 py-0.5 text-xs font-extrabold uppercase text-white">
                ...
                <div className="flex gap-2">
                  {isLive ? (
                    <Link to="/live">
                      <Button size="sm" className="bg-accent-red text-white hover:bg-accent-red/90">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => console.log("Operation successful")}
                    >
